<header class="header black-bg">
           ...
           <?php
            ...
            ?>
                 <div class="top-menu">
                  <ul class="nav pull-right top-menu">
                        <li><a class="logout" href="login/signout.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Sign Out</a></li>
            ...
            ?>
                <div class="top-menu">
                  <ul class="nav pull-right top-menu">
                        <li><a class="logout" href="login/signin.php"><i class="fa fa-sign-in" aria-hidden="true"></i>&nbsp;
                        Sign In</a></li>
