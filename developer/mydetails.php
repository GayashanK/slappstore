...
<html lang="en">
  ...
  <?php
    ...
    $sql = "SELECT * FROM developer WHERE dev_id='$varname' and status='approved'";
        $result = $conn->query($sql);
              ...
              <div class="col-lg-12">
                  ...
                  <div class="main-detail"> <!--main-detail-->
                      ...
                      <div class="dev-basic form-panel-1">
                        ...
                        <div class="dev-contact">
                          <h5><i class="fa fa-phone"></i>&nbsp;Contact Developer</h5>
                            ...
                            <h6><i class="fa fa-mobile fa-2x"></i>&nbsp;&nbsp;Mobile : <?php echo $mobile; ?>
                              <div class="form-group">
                              <a href="devupdate.php?dev_id=<?php echo $dev_id;?>"><button type="submit" class="btn btn-theme btn-xs" style="float:right; margin-left:235px; margin-bottom:10px;">Edit</button></a>
                              </div>
                    ...
                    <h5>Languages : <?php
                                                                      ...
                                                                      ?></h5>
                      <div class="form-group">
                          <a href="addskill.php?dev_id=<?php echo $dev_id;?>"><button type="submit" class="btn btn-theme btn-xs" >Edit</button></a>
                      </div>
                              ...
                              if ($result->num_rows > 0) {
                                  ...
                                  while($row = $result->fetch_assoc()) {
                                      ...
                                      <div id="portfilo">
                                        ...
                                        <div class="form-group">
                                            <a href="updateportfilo.php?portfilo_id=<?php echo $portfilo_id; ?>"><button type="submit" class="btn btn-theme btn-xs" style="float:right; margin-left:210px; margin-bottom:10px;">Edit</button></a>
                                        </div>
                                      </div>
