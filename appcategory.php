      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	...
          	<div class="row mt">
                  ...
                  <?php
                  $sql = "SELECT application.*,app_rate.* FROM application INNER JOIN app_rate ON application.app_id=app_rate.app_id WHERE application.category='$varname' and application.status='approved' LIMIT 50";
                  $result = $conn->query($sql);
                  if ($result->num_rows > 0) {
                      // output data of each row
                      while($row = $result->fetch_assoc()) {  ?>
