                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                            <h4><i class="fa fa-angle-right"></i> All Applications</h4>
                            <hr>
                              <thead>
                              <tr>
                                    ...
                                    while($row = $result->fetch_assoc()) {?>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                              ...
                                              <form action="../scripts/removerec.php?app_id=<?php echo $row['app_id']; ?>" method="post" style="display: inline; float:left;">
