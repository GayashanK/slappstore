                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                            <h4><i class="fa fa-angle-right"></i>Remove Developers</h4>
                            <hr>
                              <thead>
                              <tr>
                                    ...
                                    while($row = $result->fetch_assoc()) {?>
                                        <tr>
                                          ...
                                          <td>
                                              ...
                                              <form action="../scripts/deletedevs.php?dev_id=<?php echo $row['dev_id']; ?>" method="post" style="display: inline; float:left;">
